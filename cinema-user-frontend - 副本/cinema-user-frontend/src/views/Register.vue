...
<template>
  <div class="register-container">
    <div style="width: 50%; text-align: center;margin: 20px 0 20px 0">

            <div style="font-size: 28px;">
              <i class="iconfont icon-r-add" style="font-size: 28px;"> </i>
              <b> 注册新用户</b>
            </div>
    </div>
    <div class="register-body">
      ...
      <el-form class="register-form" ref="registerFormRef" :model="registerForm" :rules="registerFormRules" label-width="80px">
        ...
        <el-form-item>
          <el-button type="primary" @click="register" icon="iconfont icon-r-yes"> 同意以下协议并注册</el-button>
        </el-form-item>
