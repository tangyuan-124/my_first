    ...
    <el-card class="box-card">
      ...
      <el-row>
        <el-col :span="24">
          ...
          <el-button  @click="showAddDialog" style="font-size: 22px;">
            <i class="iconfont icon-add-button" style="font-size: 22px;"></i> 添加场次
          </el-button>
<!--          <el-button type="danger" @click="multipleDelete">批量删除</el-button>-->
          <el-button style="font-size: 22px;" @click="isAbleMultipleDelete">
            <i class="iconfont icon-add-button" style="font-size: 22px;"></i> 批量删除
          </el-button>
        </el-col>
      </el-row>
        ...
        <el-table-column label="操作" width="250" align="center" fixed="right">
          <template slot-scope="scope">
            <el-tooltip effect="dark" content="修改场次信息" placement="top" :enterable="false" :open-delay="500">
              <el-button @click="isAbleEdit(scope.row.sessionId)">
            ...
            <el-tooltip effect="dark" content="删除场次" placement="top" :enterable="false" :open-delay="500">
              <el-button @click="isAbleDelete(scope.row)">
            ...
            <el-tooltip effect="dark" content="查看座位" placement="top" :enterable="false" :open-delay="500">
              <el-button @click="checkSeat(scope.row.sessionId)">
    ...
    <el-dialog title="添加场次" :visible.sync="addDialogVisible" width="60%" @close="addDialogClosed">
      ...
      <el-button @click="addSession" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="修改场次" :visible.sync="editDialogVisible" width="60%" @close="editDialogClosed">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="editSessionInfo" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
