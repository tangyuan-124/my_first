...
<template>
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-row>
        <el-col :span="24">
          <el-button style="font-size: 22px" @click="getHallList">
            <i class="iconfont icon-detail-button" style="font-size: 22px;"></i> 搜索
          </el-button>
          <el-button @click="addDialogVisible = true" style="font-size: 22px;">
            <i class="iconfont icon-add-button" style="font-size: 22px;"></i> 添加影厅
          </el-button>
        ...
        <el-table-column label="操作" width="250" fixed="right">
          <template slot-scope="scope">
            <el-tooltip effect="dark" content="修改影厅信息" placement="top" :enterable="false" :open-delay="500">
              <el-button @click="isAbleEdit(scope.row.hallId)">
            ...
            <el-tooltip effect="dark" content="安排座位" placement="top" :enterable="false" :open-delay="500">
              <el-button
                ...
                <i class="iconfont icon-login-title" style="font-size: 22px;"></i>
              </el-button>
            </el-tooltip>
          </template>
        </el-table-column>
    ...
    <el-dialog title="添加影厅" :visible.sync="addDialogVisible" width="60%" @close="addDialogClosed">
      ...
      <el-button @click="addHall" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="修改影厅" :visible.sync="editDialogVisible" width="60%" @close="editDialogClosed">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="editHallInfo" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="安排座位" :visible.sync="arrangeDialogVisible" :width="arrangeDialogWidth">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="saveSeat" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
