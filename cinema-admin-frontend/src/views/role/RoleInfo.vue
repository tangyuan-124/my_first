...
<template>
  <div>
    ...
    <el-card>
      <el-row :gutter="24">
        <el-col :span="24">
          <el-button  style="font-size: 22px;" @click="addDialogVisible = true">
            <i class="iconfont icon-add-button" style="font-size: 22px;"></i> 添加角色
          </el-button>
        ...
        <el-table-column label="操作" width="300" fixed="right">
          <template slot-scope="scope">
            <el-tooltip effect="dark" content="修改角色信息" placement="top" :enterable="false" :open-delay="500">
              <el-button  @click="showEditDialog(scope.row.roleId)">
            ...
            <el-tooltip effect="dark" content="删除角色" placement="top" :enterable="false" :open-delay="500">
              <el-button  @click="isAbleDelete(scope.row.roleId)">
    ...
    <el-dialog title="添加角色" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
      ...
      <el-button  @click="addRole" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="修改角色" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="editRole" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="submitRights" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
