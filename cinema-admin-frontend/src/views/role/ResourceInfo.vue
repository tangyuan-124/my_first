  ...
  <div>
    ...
    <el-card>
      <el-row :gutter="24">
        <el-col :span="24">
          <el-button  @click="addDialogVisible = true" style="font-size: 22px;">
            <i class="iconfont icon-add-button" style="font-size: 22px;"></i> 添加资源
          </el-button>
          <el-button  @click="multipleDelete" style="font-size: 22px;">
      ...
      <el-table :data="resourceList" border stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="id" label="资源编号" width="175"></el-table-column>
        <el-table-column prop="name" label="资源名称" width="210"></el-table-column>
        <el-table-column prop="path" label="资源路径" width="210"></el-table-column>
        <el-table-column label="操作" width="300" fixed="right">
          <template slot-scope="scope">
            ...
            <el-tooltip effect="dark" content="删除资源" placement="top" :enterable="false" :open-delay="500">
              <el-button  @click="deleteResourceById(scope.row.id)">
    ...
    <el-dialog title="添加资源" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
      ...
      <el-button @click="addResource" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="修改资源" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="editResource" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
