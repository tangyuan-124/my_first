...
<template>
  <div>
      ...
      <el-row>
        <el-col :span="24">
          ...
          <el-button @click="showAddDialog" style="font-size: 22px;">
            <i class="iconfont icon-add-button" style="font-size: 22px;"></i> 添加用户
          </el-button>
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template slot-scope="scope">
            <el-tooltip effect="dark" content="修改用户信息" placement="top" :enterable="false" :open-delay="500">
              <el-button @click="showEditDialog(scope.row.userId)">
            ...
            <el-tooltip effect="dark" content="删除用户" placement="top" :enterable="false" :open-delay="500">
              <el-button @click="deleteUserById(scope.row.userId)">
    ...
    <el-dialog title="添加用户" :visible.sync="addDialogVisible" width="60%" @close="addDialogClosed">
      ...
      <el-button @click="addUser" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="修改用户信息" :visible.sync="editDialogVisible" width="60%" @close="editDialogClosed">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="editUserInfo" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
