...
<template>
  <div>
      ...
      <el-row :gutter="20">
        <el-col :span="20">
          <el-button  @click="addDialogVisible = true" style="font-size: 22px;">
            <i class="iconfont icon-detail-button" style="font-size: 22px;"></i> 添加类别
          </el-button>
          <el-button @click="multipleDelete" style="font-size: 22px;">
            <i class="iconfont icon-delete-button" style="font-size: 22px;"></i> 批量删除类别
          </el-button>
        </el-col>
      </el-row>
        ...
        <el-table-column label="操作" width="240" fixed="right">
          <template slot-scope="scope">
            <el-tooltip effect="dark" content="修改电影类别" placement="top" :enterable="false" :open-delay="500">
              <el-button @click="showEditDialog(scope.row.movieCategoryId)">
            ...
            <el-tooltip effect="dark" content="删除类别" placement="top" :enterable="false" :open-delay="500">
              <el-button @click="deleteMovieCategoryById(scope.row.movieCategoryId)">
    ...
    <el-dialog title="添加类别" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
      ...
      <el-button @click="addMovieCategory" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="修改类别" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="editMovieCategoryInfo" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
