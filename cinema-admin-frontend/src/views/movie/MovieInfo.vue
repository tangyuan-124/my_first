  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-row :gutter="20" class="row2">
        ...
        <el-col :span="24">
          <el-button @click="addDialogVisible = true" style="font-size: 22px;">
            <i class="iconfont icon-add-button" style="font-size: 22px;"></i> 添加电影
          </el-button>
          <el-button @click="isAbleMultipleDelete" style="font-size: 22px;">
            <i class="iconfont icon-delete-button" style="font-size: 22px;"></i> 批量删除
          </el-button>
        </el-col>
      </el-row>
...
<!--      操作按钮-->
      <el-table-column label="操作" width="350" fixed="right">
        <template slot-scope="scope">
          <el-tooltip effect="dark" content="查看电影信息详细" placement="top" :enterable="false" :open-delay="500">
            <el-button @click="toMovieInfo(scope.row.movieId)">
              <i class="iconfont icon-detail-button" style="font-size: 22px;"></i>
            </el-button>
          </el-tooltip>
          <el-tooltip effect="dark" content="修改电影信息" placement="top" :enterable="false" :open-delay="500">
            <el-button @click="isAbleEdit(scope.row.movieId)">
          ...
          <el-tooltip effect="dark" content="删除电影" placement="top" :enterable="false" :open-delay="500">
            <el-button @click="isAbleDelete(scope.row.movieId)">
              <i class="iconfont icon-delete-button" style="font-size: 22px;"></i>
            </el-button>
          </el-tooltip>
          <el-tooltip effect="dark" content="影片类别管理" placement="top" :enterable="false" :open-delay="500">
            <el-button @click="showEditCategoryDialog(scope.row.movieId)">
              <i class="iconfont icon-list-button" style="font-size: 22px;"></i>
            </el-button>
          </el-tooltip>
        </template>
      </el-table-column>
    ...
    <el-dialog title="添加电影" :visible.sync="addDialogVisible" width="60%" @close="addDialogClosed">
      ...
      <el-button @click="addMovie" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
...
<!--        修改图集-->
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="editMovieInfo" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
