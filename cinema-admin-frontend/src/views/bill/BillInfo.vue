  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-row>
        <el-col :span="24">
          ...
          <el-button style="font-size: 22px;" @click="multipleDelete">
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template slot-scope="scope">
            <el-tooltip effect="dark" content="修改订单信息" placement="top" :enterable="false" :open-delay="500">
              <el-button @click="showEditDialog(scope.row.billId)">
            ...
            <el-tooltip effect="dark" content="删除订单" placement="top" :enterable="false" :open-delay="500">
              <el-button @click="deleteBillById(scope.row.billId)">
    ...
    <el-dialog title="修改订单" :visible.sync="editDialogVisible" width="60%" @close="editDialogClosed">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="editBillInfo" icon="iconfont icon-sure-button"> 确 定</el-button>
      </span>
    </el-dialog>
